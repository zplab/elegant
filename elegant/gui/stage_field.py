...
class StageField(annotator.AnnotationField):
    ...
    def __init__(self, name='stage', stages=['egg', 'larva', 'adult', 'dead'], transitions=['hatch', 'adult', 'dead'], shortcuts=None, hatch_timestamp=None):
    ...
    def update_ages(self):
        ...
        process_data._update_ages(timepoint_annotations, self.hatch_timestamp, self.name, self.stages[0]):